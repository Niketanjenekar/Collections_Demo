<div align="center">
  ...
  <h1 align="center">Getting Started With</h1>
...
- And then follow the [documentation]([https://developers.themoviedb.org/3/getting-started/introduction](https://docs.docker.com/docker-id/)) to creatw new DockerHub Account.
- Finally, you can paste 
  And then paste the API Key you just created.
